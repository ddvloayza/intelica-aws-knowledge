...
### KMS encryption
- Default key: **alias/alias/itl-0004-itx-prd-kms-general-02**
...
- Engine: postgres 17.8 / Class: db.r5.large
...
- **Region:** eu-south-2
- **Encryption:** SSE-KMS with key **alias/alias/itl-0004-itx-prd-kms-general-02**
