...
- `itl-0003-portal-prd-ec2-apps-02-airflow` — ['m5.xlarge'] — desired:1 min:1 max:5
...
**Namespaces (workloads):** airflow, amazon-cloudwatch, amazon-guardduty, appsmith, default, external, external-secrets, internal, metabase, monitoring
**Deployments:** 74 — **Services:** 105
...
| itl-0003-portal-prd-lambda-sync-buk-absence-02 | dotnet10 | 256MB | 900s | Yes | itl-0003-portal-prd-lambda-sync-buk-absence-02-sg |
| itl-0003-portal-prd-lambda-sync-buk-organization-02 | dotnet10 | 256MB | 900s | Yes | itl-0003-portal-prd-lambda-sync-buk-organization-02-sg |
| itl-0003-portal-prd-lambda-sync-jira-02 | dotnet10 | 256MB | 900s | Yes | itl-0003-portal-prd-lambda-sync-jira-02-sg |

### Lambda VPC Details

**itl-0003-portal-prd-lambda-sync-jira-02**
- Runtime: dotnet10 | Memory: 256MB | Timeout: 900s
- Subnets: itl-0003-portal-prd-private-2b, itl-0003-portal-prd-private-2a
- Execution role: `itl-0003-portal-prd-lambda-sync-jira-02-role`
- KMS: _none_
...
- KMS: _none_
- Environment variable keys: ExternsAPIS__Paths__AuthenticationPath, ExternsAPIS__Paths__NotificationCallbackUrl, ExternsAPIS__Paths__SecurityPath, ENVIRONMENT, ExternsAPIS__Paths__BaseExternalUrl, AWS__Secrets__InternalAuthentication, ExternsAPIS__Paths__NotificationPath, AWS__Secrets__ConnectionString
...
**itl-0003-portal-prd-lambda-sync-buk-absence-02**
- Runtime: dotnet10 | Memory: 256MB | Timeout: 900s
- Subnets: itl-0003-portal-prd-private-2b, itl-0003-portal-prd-private-2a
- Execution role: `itl-0003-portal-prd-lambda-sync-buk-absence-02-role`
- KMS: _none_
- Environment variable keys: AWS__Secrets__ExternalCredentials, ENVIRONMENT, AWS__Secrets__ConnectionString

**itl-0003-portal-prd-lambda-sync-buk-organization-02**
- Runtime: dotnet10 | Memory: 256MB | Timeout: 900s
- Subnets: itl-0003-portal-prd-private-2b, itl-0003-portal-prd-private-2a
- Execution role: `itl-0003-portal-prd-lambda-sync-buk-organization-02-role`
- KMS: _none_
- Environment variable keys: AWS__Secrets__ExternalCredentials, ENVIRONMENT, AWS__Secrets__ConnectionString
...
| itl-0003-portal-prd-ec2-apps-02-airflow | m5.xlarge | running | itl-0003-portal-prd-private-2a | 10.10.3.73 |
